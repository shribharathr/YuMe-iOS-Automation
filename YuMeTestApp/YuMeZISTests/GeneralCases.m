...
@interface GeneralCases : XCTAsyncTestCase
...
- (void)test_GEN_001 {
    ...
    [self waitForStatus:kXCTUnitWaitStatusSuccess timeout:kTIME_OUT];
    NSLog(@"YuMeAdEventAdNotReady event fired.");

    [self runForInterval:60];
    
    NSLog(@"Prefetch Callback Timer expired.");
...
- (void)test_GEN_004 {
    ...
    // 1. YuMeAdEventAdNotReady (YuMeAdStatusRequestTimedOut): If request times out.
    NSLog(@"1. YuMeAdEventAdNotReady (YuMeAdStatusRequestTimedOut): If request times out.");
    ...
    // 2. YuMeAdEventAdNotReady (YuMeAdStatusRequestFailed): If the playlist is invalid, empty (or) non-200 OK response is received.
    NSLog(@"2. YuMeAdEventAdNotReady (YuMeAdStatusRequestFailed): If the playlist is invalid, empty (or) non-200 OK response is received.");
    ...
    // 3. YuMeAdEventAdReadyToPlay: Valid ad received and required assets found.
    NSLog(@"3. YuMeAdEventAdReadyToPlay: Valid ad received and required assets found.");
    ...
    [self waitForStatus:kXCTUnitWaitStatusSuccess timeout:kTIME_OUT];
    NSLog(@"YuMeAdEventAdReadyToPlay / YuMeAdEventAdPlaying event fired.");
...
- (void)test_GEN_006 {
    ...
    pError = nil;
    XCTAssertTrue([pYuMeSDK yumeSdkSetCacheEnabled:YES errorInfo:&pError], @"yumeSdkSetCacheEnabled failed.");
    ...
    [self waitForStatus:kXCTUnitWaitStatusSuccess timeout:kTIME_OUT];
    NSLog(@"YuMeAdEventAdReadyToPlay / YuMeAdEventAdNotReady event fired.");
}
...
- (void)test_GEN_020 {
    ...
    XCTAssertTrue([pYuMeSDK yumeSdkModifyAdParams:params errorInfo:&pError], @"yumeSdkModifyAdParams failed.");
    
    [self runForInterval:1];
    
    pError = nil;
    XCTAssertTrue([pYuMeSDK yumeSdkInitAd:&pError], @"yumeSdkInitAd failed.");
    NSLog(@"yumeSdkInitAd Successful.");
