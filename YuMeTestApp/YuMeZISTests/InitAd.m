...
@interface InitAd : XCTAsyncTestCase
...
- (void)test_INIT_AD_001 {
    ...
    XCTAssertFalse([pYuMeSDK yumeSdkInitAd:&pError], @"yumeSdkInitAd() Successful.");
    if (pError) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError];
        XCTAssertEqualObjects(str, @"yumeSdkInitAd(): YuMe SDK is not Initialized.", @"yumeSdkInitAd(): YuMe SDK is not Initialized.");
        NSLog(@"Result : %@", str);
    }
}
...
- (void)test_INIT_AD_010 {
    ...
    NSLog(@"Starts Prefetch Request Callback Timer.");
...
- (void)test_INIT_AD_022 {
    ...
    NSLog(@"yumeSdkInitAd API called again");
...
- (void)test_INIT_AD_025 {
    ...
    if (pError) {
        ...
        XCTAssertEqualObjects(str, @"yumeSdkInitAd(): Previous STREAMING Ad Play in Progress.", @"yumeSdkInitAd(): Previous STREAMING Ad Play in Progress.");
        NSLog(@"Result: %@", str);
    }
    NSLog(@"yumeSdkInitAd API called");
...
- (void)test_INIT_AD_026 {
    ...
    [self performSelectorInBackground:@selector(initAdEventListener:) withObject:userInfo2];
    [self waitForStatus:kXCTUnitWaitStatusSuccess timeout:kTIME_OUT];
    NSLog(@"YuMeAdEventAdPlaying event.");
    ...
    if (pError) {
        NSString *str = [[YuMeUnitTestUtils getErrDesc:pError] description];
        XCTAssertEqualObjects(str, @"yumeSdkInitAd(): Previous PREFETCED Ad Play in Progress.", @"yumeSdkInitAd(): Previous PREFETCED Ad Play in Progress.");
        NSLog(@"Result: %@", str);
    }
    NSLog(@"yumeSdkInitAd API called");
...
- (void)test_INIT_AD_027 {
    ...
    NSLog(@"Invalid filled response received.");
    ...
    NSLog(@"yumeSdkInitAd called again");
...
- (void)test_INIT_AD_029 {
    ...
    NSLog(@"Empty prefetched ad is already available.");
