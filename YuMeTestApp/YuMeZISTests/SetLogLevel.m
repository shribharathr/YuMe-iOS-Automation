...
@interface SetLogLevel : XCTAsyncTestCase
@end

@implementation SetLogLevel
...
- (void)setLogEventListener:(NSArray *)userInfo {
...
- (void)test_SET_LL_002 {
    ...
    [self performSelectorInBackground:@selector(setLogEventListener:) withObject:userInfo];
