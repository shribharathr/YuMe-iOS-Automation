...
@interface ShowAdStreaming : GHAsyncTestCase
...
- (void)test_SHOW_AD_STR_001 {
    ...
    GHAssertFalse([pYuMeSDK yumeSdkShowAd:pYuMeInterface.yViewController.view viewController:pYuMeInterface.yViewController errorInfo:&pError], @"");
    if (pError) {
...
- (void)test_SHOW_AD_STR_002 {
    ...
    GHAssertFalse([pYuMeSDK yumeSdkShowAd:adDisplayViewController.view viewController:presentedAdViewController errorInfo:&pError], @"");
    if (pError) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError];
...
- (void)test_SHOW_AD_STR_003 {
    ...
    pError = nil;
    GHAssertFalse([pYuMeSDK yumeSdkShowAd:nil viewController:pYuMeInterface.yViewController errorInfo:&pError], @"");
    if (pError) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError];
        GHAssertEqualObjects(str, @"yumeSdkShowAd(): Invalid Ad View handle.", @"");
        GHTestLog(@"Result: %@", str);
    }
    ...
    pError = nil;
    GHAssertFalse([pYuMeSDK yumeSdkShowAd:pYuMeInterface.yViewController.view viewController:nil errorInfo:&pError], @"");
    if (pError) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError];
        GHAssertEqualObjects(str, @"yumeSdkShowAd(): Invalid Ad View Controller handle.", @"");
        GHTestLog(@"Result: %@", str);
    }
    pError = nil;
}
...
- (void)test_SHOW_AD_STR_005 {
    ...
    if (!bSDKInitalized) {
        ...
        GHTestLog(@" YuMeAdEventInitSuccess event.");
