...
@interface Init : GHAsyncTestCase
...
- (void)test_INIT_002 {
...
#if pYuMeMPlayerController
        GHAssertFalse([pYuMeSDK yumeSdkInit:params
                               appDelegate:pYuMeInterface
    ...
    if (pError) {
        ...
        GHAssertEqualStrings(str, @"yumeSdkInit(): Invalid Ad Params Object.", @"");
...
- (void)test_INIT_003 {
    ...
    GHAssertNil(params.pDomainId, @"params.pDomainId object is NULL");
    GHTestLog(@"Test AdParams: \n%@", [YuMeUnitTestUtils getStringYuMeAdParms:params]);
...
- (void)test_INIT_004 {
    ...
    pYuMeInterface = nil;
    GHAssertNil(pYuMeInterface, @"pYuMeInterface object is nil");
    GHAssertNotNil(pYuMeSDK, @"pYuMeSDK object not found");
...
- (void)test_INIT_006 {
    ...
    GHAssertNotNil(pYuMeInterface, @"pYuMeInterface object not found");
    GHAssertNotNil(pYuMeSDK, @"yumeSDK object not found");
    ...
    if (pError1) {
        ...
        GHAssertEqualStrings(str, @"yumeSdkInit(): Initialization Process already in Progress - 1.", @"");
        GHTestLog(@"Result : %@", str);
    }
...
- (void)test_INIT_007 {
    ...
    if (pError1) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError1];
        GHAssertEqualStrings(str, @"yumeSdkInit(): Initialization Process already in Progress - 2.", @"");
        GHTestLog(@"Result : %@", str);
    }
...
- (void)test_INIT_008 {
    ...
    GHAssertNotNil(pYuMeInterface, @"pYuMeInterface object not nil");
    GHAssertNotNil(pYuMeSDK, @"yumeSDK object not nil");
    
    YuMeAdParams *params = [YuMeUnitTestUtils getApplicationYuMeAdParams];
    GHAssertNotNil(params, @"params object not nil");
    GHTestLog(@"Test AdParams: \n%@", [YuMeUnitTestUtils getStringYuMeAdParms:params]);
    ...
    // Call init Again
    GHAssertFalse([pYuMeSDK yumeSdkInit:params appDelegate:pYuMeInterface errorInfo:&pError1] , @"New Init Call ignored.");
...
- (void)test_INIT_009 {
    ...
    if (pError1) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError1];
        GHAssertEqualStrings(str, @"yumeSdkInit(): YuMe SDK is already Initialized, Delegate updated.", @"");
        GHTestLog(@"Result : %@", str);
    }
}
...
- (void)test_INIT_010 {
    ...
    if (pError1) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError1];
        GHAssertEqualStrings(str, @"yumeSdkInit(): YuMe SDK is already Initialized, Invalid Delegate received and ignored.", @"");
        GHTestLog(@"Result : %@", str);
    }
}
...
- (void)test_INIT_011 {
    ...
    GHAssertNotNil(pYuMeInterface, @"pYuMeInterface object not nil");
    GHAssertNotNil(pYuMeSDK, @"pYuMeSDK object not nil");
...
- (void)test_INIT_022 {
    ...
    GHAssertEquals(adParams.adTimeout, 5, @"YuMe Ad Params retrieved and sets the ad timeout to the default value of 5 seconds");
}
...
- (void)test_INIT_023 {
    ...
    GHAssertEquals(adParams.videoTimeout, 6, @"YuMe Ad Params retrieved and sets the video timeout to the default value of 6 seconds");
}
...
- (void)test_INIT_027 {
    ...
    if (pError) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError];
        GHAssertEqualStrings(str, @"yumeSdkInit(): Invalid Progressive Download Timeout Value. It cannot exceed 60.", @"");
        GHTestLog(@"Result : %@", str);
    }
    GHTestLog(@"Notifies YuMeAdEventInitFailed event.");
    GHTestLog(@"Result: Initialization Fails.");
