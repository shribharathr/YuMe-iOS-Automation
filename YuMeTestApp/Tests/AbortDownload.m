...
@interface AbortDownload : GHAsyncTestCase
...
- (void)test_AD_001 {
    ...
    GHAssertFalse([pYuMeSDK yumeSdkAbortDownload:&pError], @"yumeSdkAbortDownload() Successful.");
    if (pError) {
        NSString *str = [YuMeUnitTestUtils getErrDesc:pError];
        GHAssertEqualStrings(str, @"yumeSdkAbortDownload(): YuMe SDK is not Initialized.", @"yumeSdkAbortDownload(): YuMe SDK is not Initialized.");
